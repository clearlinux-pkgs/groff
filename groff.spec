...
#
# Source0 file verified with key 0x72D23FBAC99D4E75 (bertrand.garrigues@laposte.net)
#
Name     : groff
Version  : 1.23.0
Release  : 27
URL      : https://mirrors.kernel.org/gnu/groff/groff-1.23.0.tar.gz
Source0  : https://mirrors.kernel.org/gnu/groff/groff-1.23.0.tar.gz
Source1  : https://mirrors.kernel.org/gnu/groff/groff-1.23.0.tar.gz.sig
Summary  : GNU troff, a typesetting system
Group    : Development/Tools
License  : BSD-3-Clause GFDL-1.3 GPL-3.0 GPL-3.0+ MIT
...
%prep
%setup -q -n groff-1.23.0
cd %{_builddir}/groff-1.23.0
pushd ..
cp -a groff-1.23.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688665672
...
cp %{_builddir}/groff-%{version}/COPYING %{buildroot}/usr/share/package-licenses/groff/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
...
/V3/usr/bin/pfbtops
/V3/usr/bin/pic
/V3/usr/bin/post-grohtml
/V3/usr/bin/pre-grohtml
/V3/usr/bin/preconv
/V3/usr/bin/refer
/V3/usr/bin/soelim
/V3/usr/bin/tbl
